class SwapCallbackParams {
    ...
    getString() {
        var str = "?bridge=" + this.bridge + "&token0=" + this.token0 + "&token1=" + this.token1 + "&decimal0=" + this.decimal0 +
            ...
            + "&toChainID=" + this.toChainID + "&channel=" + this.channel + "&issuer=" + this.issuer + "&amountOutMin=" + this.amountOutMin +
            "&hash=" + this.hash
        return str
    }
}

module.exports = SwapCallbackParams 